      ...
      <div className="relative flex w-full max-w-[984px] flex-col items-center justify-center gap-y-4">
        <nav>
          ...
          <div className="absolute -top-4 right-4 md:-top-8 md:right-8 lg:right-0">
            <DialogFAQ linkWhatsApp="https://wa.me/5491124058816" />
          </div>
        </nav>

        <section className="flex flex-col items-center justify-center">
          <h2 className="text-lg font-bold leading-7">Hillsong Buenos Aires</h2>
        ...
        <ol className="flex gap-x-4">
          <li>
            <Link href="https://hillsong.com/argentina/buenosaires/" target="_blank">
          ...
          <li>
            <Link
              href="https://www.instagram.com/hillsongbuenosaires/"
              target="_blank"
            >
          ...
          <li>
            <Link href="https://www.youtube.com/@HillsongBuenosAires" target="_blank">
